...
import com.vitily.common.exception.DuplicateDataException;
...
public abstract class Assert {
    ...
    public final static void equal(Integer a,Integer b,String message){
        if(!CommonUtil.isEqual(a,b)) throw new CustomerException(message, CommonEnumContainer.ResultStatus.参数不符合要求);
    }
    ...
    private static void instanceCheckFailed(Class<?> type, Object obj, String msg) {
        ...
        throw new CustomerException(result, CommonEnumContainer.ResultStatus.参数不符合要求);
    }

...
//        }
    ...
    public static void main(String[] args){
        ...
        a = System.currentTimeMillis();
        for(int i=0;i<1000;++i) {
            new GUIDGenerator().toString();
        }
        System.out.println(System.currentTimeMillis()-a);
        System.out.println(UUIDGenerator.getInstance().generateTimeBasedUUID().toString());
        System.out.println(UUIDGenerator.getInstance().generateTimeBasedUUID().toString());
        System.out.println(UUIDGenerator.getInstance().generateRandomBasedUUID().toString());
        System.out.println(UUIDGenerator.getInstance().generateRandomBasedUUID().toString());
    }
